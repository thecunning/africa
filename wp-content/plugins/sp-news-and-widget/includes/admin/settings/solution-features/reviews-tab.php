...
<div id="wpnw_review_tabs" class="wpnw-vtab-cnt wpnw_review_tabs wpnw-clearfix">
		...
		<div class="wpnw-testimonial-section-inr">
			<div class="wpnw-testimonial-box-wrap">
				<div class="wpnw-testimonial-box-grid">
					...
					<div class="wpnw-testimonial-rating"><img src="<?php echo esc_url(WPNW_URL); ?>assets/images/rating.png" /></div>
				</div>
				<div class="wpnw-testimonial-box-grid">
			...
			<a href="https://wordpress.org/support/plugin/sp-news-and-widget/reviews/?filter=5" target="_blank" class="wpnw-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a>
		</div>
	</div>
